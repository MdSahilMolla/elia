...
const REGISTRY_URL = 'https://registry.npmjs.org/elia-ai/latest'
...
export function renderUpdateNotice(update: AvailableUpdate): string {
  return `Update available: ${update.currentVersion} → ${update.latestVersion}. Run: npm install --global elia-ai@latest`
}
